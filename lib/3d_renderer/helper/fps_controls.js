...
module.exports = class Renderer_Helper_FPS_Controls extends Base
{
	...
	// This overrides default in shrines (too fast) - PerlDude
        this.camSpeed = 0.0625;

	// new - default for shrines
	this.boostSpeed = 1.0;
    ...
    _handlerKeys(e)
    {
	    ...
	    // PerlDude - I miss boost speed hot key...
	    case "ShiftLeft":
			this.camMoveSpeed = isKeyDown ? this.boostSpeed : this.camSpeed;
	    break;
        }
